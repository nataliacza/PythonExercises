import unittest
from challenges.task_013 import sort_by_row, sort_by_row_2
...
class TestOfSortFunctionTwo(unittest.TestCase):

    def test_function_1(self):
        result = sort_by_row_2(list1)
        expected = expected1
        self.assertEqual(result, expected)

    def test_function_2(self):
        result = sort_by_row_2(list2)
        expected = expected2
        self.assertEqual(result, expected)
